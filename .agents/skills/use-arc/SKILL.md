...
### ERC-8004 AI Agent Contracts (Arc Testnet)
| Contract | Address |
|----------|---------|
...
- **ERC-8004**: Arc's AI agent identity standard. Agents are registered as NFTs with onchain identity, reputation, and validation.
...
### 5. Register an AI Agent (ERC-8004)
See `scripts/register-agent.ts` in this project for the full registration flow using Circle developer-controlled wallets.
